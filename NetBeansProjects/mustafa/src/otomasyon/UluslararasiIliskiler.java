...
public class UluslararasiIliskiler extends Ogrenci{
    
    static String siniflar[] = {"    d103    ", "    d515    ", "    d521    ", "    a120    "};
    
    static Ders cografya = new Ders("  Cografya  ", 4, siniflar[1], saatler[0], gunler[0]);
    static Ders ingilizce = new Ders("  Ingilizce  ", 4, siniflar[3], saatler[1], gunler[1]);
    ...
    static Ders terminoloji = new Ders("Terminoloji ", 3, siniflar[0], saatler[0], gunler[4]);
    ...
    static Ders dersler[]={cografya,ingilizce,sosyoloji,iktisat,terminoloji,inklap,turkdili,beden,guzelsanatlar,programlama,ekonomi};
    
    static void dersSecimi(Ogrenci ogrenci) {
        int kredi = 0;
        System.out.println("Ders secini...(toplam kredi 16-20 arasi olmalidir)");
        System.out.println("1- " + cografya.dersAdi + "/" + cografya.kredi);
        System.out.println("2- " + ingilizce.dersAdi + "/" + ingilizce.kredi);
        System.out.println("3- " + sosyoloji.dersAdi + "/" + sosyoloji.kredi);
        System.out.println("4- " + iktisat.dersAdi + "/" + iktisat.kredi);
        System.out.println("5- " + terminoloji.dersAdi + "/" + terminoloji.kredi);
        ...
        switch (input.nextInt()) {
            case 1:
                if(d1==false){
                ogrenci.dersler[ogrenci.dersSayisi] = cografya;
                ogrenci.dersSayisi++;
                kredi += 4;
                System.out.println(cografya.dersAdi+" secildi.");
            ...
            case 2:
                if(d2==false){
                ogrenci.dersler[ogrenci.dersSayisi] = ingilizce;
                ogrenci.dersSayisi++;
                kredi += 4;
                System.out.println(ingilizce.dersAdi+" secildi.");
                System.out.println("alınan kredi= "+kredi+" kalan max kredi: "+(20-kredi));
                d2=true;}
                else
                    System.out.println("Sectiginiz dersi bir daha secemezsiniz!");
            ...
            case 5:
            if(d5==false){
                ogrenci.dersler[ogrenci.dersSayisi] = terminoloji;
                ogrenci.dersSayisi++;
                kredi += 3;
                System.out.println(terminoloji.dersAdi+" secildi.");
                System.out.println("alınan kredi= "+kredi+" kalan max kredi: "+(20-kredi));
                d5=true;}
                else
                    System.out.println("Sectiginiz dersi bir daha secemezsiniz!");
    ...
    static void dersSecimi(Egitimci egitimci) {
        System.out.println("Verilecek dersi seciniz...");
            for (int i = 0; i < 11; i++) {
                System.out.println((i + 1) + "-" + UluslararasiIliskiler.dersler[i].dersAdi);
            }
            switch (input.nextInt()) {
                case 1:
                    egitimciler[egitimciSayisi].verilenDers = UluslararasiIliskiler.dersler[0];
                    break;
                case 2:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[1];
                    break;
                case 3:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[2];
                    break;
                case 4:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[3];
                    break;
                case 5:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[4];
                    break;
                case 6:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[5];
                    break;
                case 7:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[6];
                    break;
                case 8:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[7];
                    break;
                case 9:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[8];
                    break;
                case 10:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[9];
                    break;
                case 11:
                    egitimci.verilenDers = UluslararasiIliskiler.dersler[10];
                    break;
        }
    }
}
