...
public abstract class Isletme extends Ogrenci{
    
    static String siniflar[] = {"    d501    ", "    d512    ", "    d704    ", "    a402    "};
    ...
    static Ders mikro = new Ders("Mikro Eknomi", 3, siniflar[0], saatler[0], gunler[4]);
    ...
    static Ders dersler[]={mat,isletme,sosyoloji,iktisat,mikro,inklap,turkdili,beden,guzelsanatlar,programlama,ekonomi};
    ...
    static void dersSecimi(Ogrenci ogrenci) {
        ...
        System.out.println("5- " + mikro.dersAdi + "/" + mikro.kredi);
        ...
        switch (input.nextInt()) {
            ...
            case 5:
            if(d5==false){
                ogrenci.dersler[ogrenci.dersSayisi] = mikro;
                ogrenci.dersSayisi++;
                kredi += 3;
                System.out.println(mikro.dersAdi+" secildi.");
                System.out.println("alınan kredi= "+kredi+" kalan max kredi: "+(20-kredi));
                d5=true;}
                else
                    System.out.println("Sectiginiz dersi bir daha secemezsiniz!");
    ...
    static void dersSecimi(Egitimci egitimci) {
        System.out.println("Verilecek dersi seciniz...");
            for (int i = 0; i < 11; i++) {
                System.out.println((i + 1) + "-" + Isletme.dersler[i].dersAdi);
            }
            switch (input.nextInt()) {
                case 1:
                    egitimciler[egitimciSayisi].verilenDers = Isletme.dersler[0];
                    break;
                case 2:
                    egitimci.verilenDers = Isletme.dersler[1];
                    break;
                case 3:
                    egitimci.verilenDers = Isletme.dersler[2];
                    break;
                case 4:
                    egitimci.verilenDers = Isletme.dersler[3];
                    break;
                case 5:
                    egitimci.verilenDers = Isletme.dersler[4];
                    break;
                case 6:
                    egitimci.verilenDers = Isletme.dersler[5];
                    break;
                case 7:
                    egitimci.verilenDers = Isletme.dersler[6];
                    break;
                case 8:
                    egitimci.verilenDers = Isletme.dersler[7];
                    break;
                case 9:
                    egitimci.verilenDers = Isletme.dersler[8];
                    break;
                case 10:
                    egitimci.verilenDers = Isletme.dersler[9];
                    break;
                case 11:
                    egitimci.verilenDers = Isletme.dersler[10];
                    break;
        }
    }
}
