...
public class KamuYonetimi extends Ogrenci{
    static String siniflar[] = {"    d101    ", "    d402    ", "    d610    ", "    a420    "};
    
    static Ders kyg = new Ders("    KYG     ", 4, siniflar[1], saatler[0], gunler[0]);
    static Ders psikoloji = new Ders("T. Psikoloji", 4, siniflar[3], saatler[1], gunler[1]);
    ...
    static Ders cografya = new Ders("  Cografya  ", 3, siniflar[0], saatler[0], gunler[4]);
    ...
    static Ders dersler[]={kyg,psikoloji,sosyoloji,iktisat,cografya,inklap,turkdili,beden,guzelsanatlar,programlama,ekonomi};
    
    static void dersSecimi(Ogrenci ogrenci) {
        int kredi = 0;
        System.out.println("Ders secini...(toplam kredi 16-20 arasi olmalidir)");
        System.out.println("1- " + kyg.dersAdi + "/" + kyg.kredi);
        System.out.println("2- " + psikoloji.dersAdi + "/" + psikoloji.kredi);
        System.out.println("3- " + sosyoloji.dersAdi + "/" + sosyoloji.kredi);
        System.out.println("4- " + iktisat.dersAdi + "/" + iktisat.kredi);
        System.out.println("5- " + cografya.dersAdi + "/" + cografya.kredi);
        ...
        switch (input.nextInt()) {
            case 1:
                if(d1==false){
                ogrenci.dersler[ogrenci.dersSayisi] = kyg;
                ogrenci.dersSayisi++;
                kredi += 4;
                System.out.println(kyg.dersAdi+" secildi.");
            ...
            case 2:
                if(d2==false){
                ogrenci.dersler[ogrenci.dersSayisi] = psikoloji;
                ogrenci.dersSayisi++;
                kredi += 4;
                System.out.println(psikoloji.dersAdi+" secildi.");
                System.out.println("alınan kredi= "+kredi+" kalan max kredi: "+(20-kredi));
                d2=true;}
                else
                    System.out.println("Sectiginiz dersi bir daha secemezsiniz!");
    ...
    static void dersSecimi(Egitimci egitimci) {
        System.out.println("Verilecek dersi seciniz...");
            for (int i = 0; i < 11; i++) {
                System.out.println((i + 1) + "-" + KamuYonetimi.dersler[i].dersAdi);
            }
            switch (input.nextInt()) {
                case 1:
                    egitimciler[egitimciSayisi].verilenDers = KamuYonetimi.dersler[0];
                    break;
                case 2:
                    egitimci.verilenDers = KamuYonetimi.dersler[1];
                    break;
                case 3:
                    egitimci.verilenDers = KamuYonetimi.dersler[2];
                    break;
                case 4:
                    egitimci.verilenDers = KamuYonetimi.dersler[3];
                    break;
                case 5:
                    egitimci.verilenDers = KamuYonetimi.dersler[4];
                    break;
                case 6:
                    egitimci.verilenDers = KamuYonetimi.dersler[5];
                    break;
                case 7:
                    egitimci.verilenDers = KamuYonetimi.dersler[6];
                    break;
                case 8:
                    egitimci.verilenDers = KamuYonetimi.dersler[7];
                    break;
                case 9:
                    egitimci.verilenDers = KamuYonetimi.dersler[8];
                    break;
                case 10:
                    egitimci.verilenDers = KamuYonetimi.dersler[9];
                    break;
                case 11:
                    egitimci.verilenDers = KamuYonetimi.dersler[10];
                    break;
        }
    }
}
